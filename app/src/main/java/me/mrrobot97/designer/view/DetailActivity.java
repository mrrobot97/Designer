...
public class DetailActivity extends SwipeBackActivity implements IDetailView{
    ...
    private void init() {
        ...
        mBuilder.setItems(new String[]{"保存图片"},new DialogInterface.OnClickListener(){
        ...
        frontImageView.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
        ...
        avatar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Build.VERSION.SDK_INT<Build.VERSION_CODES.LOLLIPOP){
                    ...
                    //5.0及以上系统实现共享元素动画
                    ActivityOptionsCompat options=ActivityOptionsCompat.makeSceneTransitionAnimation(DetailActivity.this
                            ,avatar,getString(R.string.transitionAvatar));
    ...
    private void shareShot() {
        ...
        intent.putExtra(Intent.EXTRA_TEXT,"I found an amazing design in dribbble: "+mShot.getHtml_url());
    ...
    private void saveImage() {
        ...
        final File file=new File(dir,frontImageUrl.substring(frontImageUrl.lastIndexOf(File.separator),frontImageUrl.length()));
        Observable.defer(new Func0<Observable<Void>>() {
            ...
            public void onNext(Void aVoid) {
                ...
                Toast.makeText(DetailActivity.this, "Save image to "+file.getAbsolutePath(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    @Override
    public void showComments(List<Comment> commments) {
        mComments=commments;
    ...
    @Override
    public void showAttachments(final List<Attachment> attachments) {
        ...
        attachAdapter.setListener(new ShotsAdapter.OnItemClickListener() {
            @Override
    ...
    class MyAdapter extends RecyclerView.Adapter{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view= LayoutInflater.from(DetailActivity.this).inflate(R.layout.comment_item_layout,parent,false);
        ...
        public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
            ...
            Glide.with(DetailActivity.this).load(comment.getUser().getAvatar_url()).asBitmap().into(target);
